...
func CreateEmail(e *echo.Echo, email string, url string, templateName string, subject string) error {
	...
	html, _ := template.New(fmt.Sprint(templateName, ".html")).ParseFiles(fmt.Sprint(wd, "/templates/email/", templateName, ".html"))
	plaintext, _ := template.New(fmt.Sprint(templateName, ".txt")).ParseFiles(fmt.Sprint(wd, "/templates/email/", templateName, ".txt"))
